    ...
    <div class="grid gap-10 lg:grid-cols-2">
      <div class="flex flex-col justify-center md:pr-8 xl:pr-0 lg:max-w-lg">
        ...
        <div class="max-w-xl mb-6">
          ...
          >
            I believe all my efforts<br class="hidden md:block" />
            <span class="inline-block text-deep-purple-accent-400"
              >aren’t a wasted.</span
            >
          </h2>
          <p class="text-base text-gray-700 md:text-lg">
            I'm Chartchaloem Tepa, a student from Software engineering, University of Phayao. Nice to meet you.
          </p>
        </div>
      </div>
